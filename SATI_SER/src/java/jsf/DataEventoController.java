...
public class DataEventoController implements Serializable {
    ...
    public void carregaAll() {
        all = ejbFacade.listAllOrd();
        for (DataEvento item : all) {
            int ocupadas = ejbFacade.vagasFechadas(item.getIdevento());
